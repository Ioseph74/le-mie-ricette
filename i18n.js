...
var translations = {
    ...
    "filter.all": { en: "All Recipes", it: "Tutte le Ricette", fr: "Toutes les Recettes", de: "Alle Rezepte", es: "Todas las Recetas" },
    "filter.mine": { en: "My Recipes", it: "Le Mie", fr: "Mes Recettes", de: "Meine Rezepte", es: "Mis Recetas" },
    "filter.favorites": { en: "Favorites", it: "Preferite", fr: "Favoris", de: "Favoriten", es: "Favoritas" },
    "filter.following": { en: "Following", it: "Seguiti", fr: "Abonnements", de: "Abonniert", es: "Seguidos" },
    "fav.add": { en: "Add to favorites", it: "Aggiungi ai preferiti", fr: "Ajouter aux favoris", de: "Zu Favoriten hinzufuegen", es: "Anadir a favoritos" },
    "fav.remove": { en: "Remove from favorites", it: "Rimuovi dai preferiti", fr: "Retirer des favoris", de: "Aus Favoriten entfernen", es: "Quitar de favoritos" },
    "fav.added": { en: "Added to favorites!", it: "Aggiunto ai preferiti!", fr: "Ajoute aux favoris!", de: "Zu Favoriten hinzugefuegt!", es: "Anadido a favoritos!" },
    "fav.removed": { en: "Removed from favorites", it: "Rimosso dai preferiti", fr: "Retire des favoris", de: "Aus Favoriten entfernt", es: "Quitado de favoritos" },
    "follow.follow": { en: "Follow", it: "Segui", fr: "Suivre", de: "Folgen", es: "Seguir" },
    "follow.following": { en: "Following", it: "Segui gia", fr: "Abonne", de: "Abonniert", es: "Siguiendo" },
    "follow.followed": { en: "Now following!", it: "Ora segui questo utente!", fr: "Abonne!", de: "Jetzt abonniert!", es: "Ahora siguiendo!" },
    "follow.unfollowed": { en: "Unfollowed", it: "Non segui piu", fr: "Desabonne", de: "Entfolgt", es: "Dejaste de seguir" },
    "copy.suffix": { en: "Copy", it: "Copia", fr: "Copie", de: "Kopie", es: "Copia" },
    "copy.success": { en: "Recipe copied! Opening editor...", it: "Ricetta copiata! Apertura editor...", fr: "Recette copiee! Ouverture editeur...", de: "Rezept kopiert! Editor wird geoeffnet...", es: "Receta copiada! Abriendo editor..." },
    "copy.error": { en: "Error copying recipe", it: "Errore nella copia", fr: "Erreur de copie", de: "Fehler beim Kopieren", es: "Error al copiar" },
    "settings.title": { en: "Settings", it: "Impostazioni", fr: "Parametres", de: "Einstellungen", es: "Configuracion" },
    "settings.profile": { en: "Profile", it: "Profilo", fr: "Profil", de: "Profil", es: "Perfil" },
    "settings.preferences": { en: "Preferences", it: "Preferenze", fr: "Preferences", de: "Einstellungen", es: "Preferencias" },
    "settings.language": { en: "Language", it: "Lingua", fr: "Langue", de: "Sprache", es: "Idioma" },
    "settings.units": { en: "Unit System", it: "Sistema di misura", fr: "Systeme de mesure", de: "Masseinheiten", es: "Sistema de medidas" },
    "settings.saved": { en: "Settings saved!", it: "Impostazioni salvate!", fr: "Parametres enregistres!", de: "Einstellungen gespeichert!", es: "Configuracion guardada!" },
    "settings.stats": { en: "Statistics", it: "Statistiche", fr: "Statistiques", de: "Statistiken", es: "Estadisticas" },
    "settings.myRecipes": { en: "My Recipes", it: "Le Mie Ricette", fr: "Mes Recettes", de: "Meine Rezepte", es: "Mis Recetas" },
    "settings.myFavorites": { en: "Favorites", it: "Preferiti", fr: "Favoris", de: "Favoriten", es: "Favoritos" },
    "settings.myFollowing": { en: "Following", it: "Seguiti", fr: "Abonnements", de: "Abonniert", es: "Seguidos" },
    "settings.notLoggedIn": { en: "Please sign in to access settings.", it: "Accedi per accedere alle impostazioni.", fr: "Connectez-vous pour acceder aux parametres.", de: "Melden Sie sich an, um auf die Einstellungen zuzugreifen.", es: "Inicie sesion para acceder a la configuracion." },
    "visibility.title": { en: "Visibility", it: "Visibilita", fr: "Visibilite", de: "Sichtbarkeit", es: "Visibilidad" },
    "visibility.public": { en: "Public — visible to everyone", it: "Pubblica — visibile a tutti", fr: "Publique — visible par tous", de: "Oeffentlich — fuer alle sichtbar", es: "Publica — visible para todos" },
    "visibility.private": { en: "Private — only you can see it", it: "Privata — solo tu puoi vederla", fr: "Privee — visible uniquement par vous", de: "Privat — nur fuer Sie sichtbar", es: "Privada — solo tu puedes verla" },
    "tags.title": { en: "Tags", it: "Tag", fr: "Tags", de: "Tags", es: "Etiquetas" },
    "tags.diet": { en: "Diet", it: "Dieta", fr: "Regime", de: "Diaet", es: "Dieta" },
    "tags.allergen": { en: "Allergen Free", it: "Senza Allergeni", fr: "Sans Allergenes", de: "Allergenfrei", es: "Sin Alergenos" },
    "tags.style": { en: "Style", it: "Stile", fr: "Style", de: "Stil", es: "Estilo" },
    "tag.diet.vegetarian": { en: "Vegetarian", it: "Vegetariana", fr: "Vegetarien", de: "Vegetarisch", es: "Vegetariana" },
    "tag.diet.vegan": { en: "Vegan", it: "Vegana", fr: "Vegan", de: "Vegan", es: "Vegana" },
    "tag.diet.keto": { en: "Keto", it: "Keto", fr: "Keto", de: "Keto", es: "Keto" },
    "tag.diet.low-carb": { en: "Low Carb", it: "Low Carb", fr: "Low Carb", de: "Low Carb", es: "Low Carb" },
    "tag.diet.paleo": { en: "Paleo", it: "Paleo", fr: "Paleo", de: "Paleo", es: "Paleo" },
    "tag.diet.mediterranean": { en: "Mediterranean", it: "Mediterranea", fr: "Mediterraneen", de: "Mediterran", es: "Mediterranea" },
    "tag.diet.low-fat": { en: "Low Fat", it: "Basso contenuto di grassi", fr: "Faible en gras", de: "Fettarm", es: "Bajo en grasa" },
    "tag.diet.high-protein": { en: "High Protein", it: "Alto contenuto proteico", fr: "Riche en proteines", de: "Proteinreich", es: "Alto en proteinas" },
    "tag.diet.whole30": { en: "Whole30", it: "Whole30", fr: "Whole30", de: "Whole30", es: "Whole30" },
    "tag.allergen.gluten-free": { en: "Gluten Free", it: "Senza Glutine", fr: "Sans Gluten", de: "Glutenfrei", es: "Sin Gluten" },
    "tag.allergen.lactose-free": { en: "Lactose Free", it: "Senza Lattosio", fr: "Sans Lactose", de: "Laktosefrei", es: "Sin Lactosa" },
    "tag.allergen.dairy-free": { en: "Dairy Free", it: "Senza Latticini", fr: "Sans Produits Laitiers", de: "Milchfrei", es: "Sin Lacteos" },
    "tag.allergen.nut-free": { en: "Nut Free", it: "Senza Noci", fr: "Sans Noix", de: "Nussfrei", es: "Sin Frutos Secos" },
    "tag.allergen.egg-free": { en: "Egg Free", it: "Senza Uova", fr: "Sans Oeufs", de: "Eifrei", es: "Sin Huevo" },
    "tag.allergen.soy-free": { en: "Soy Free", it: "Senza Soia", fr: "Sans Soja", de: "Sojafrei", es: "Sin Soja" },
    "tag.allergen.sugar-free": { en: "Sugar Free", it: "Senza Zucchero", fr: "Sans Sucre", de: "Zuckerfrei", es: "Sin Azucar" },
    "tag.allergen.shellfish-free": { en: "Shellfish Free", it: "Senza Crostacei", fr: "Sans Crustaces", de: "Schalentierfrei", es: "Sin Mariscos" },
    "tag.style.quick": { en: "Quick", it: "Veloce", fr: "Rapide", de: "Schnell", es: "Rapida" },
    "tag.style.no-cook": { en: "No Cook", it: "Senza Cottura", fr: "Sans Cuisson", de: "Ohne Kochen", es: "Sin Coccion" },
    "tag.style.kid-friendly": { en: "Kid Friendly", it: "Per Bambini", fr: "Pour Enfants", de: "Kinderfreundlich", es: "Para Ninos" },
    "tag.style.light": { en: "Light", it: "Light", fr: "Light", de: "Leicht", es: "Light" },
    "tag.style.comfort-food": { en: "Comfort Food", it: "Comfort Food", fr: "Plat Reconfortant", de: "Soulfood", es: "Comfort Food" },
    "tag.style.meal-prep": { en: "Meal Prep", it: "Meal Prep", fr: "Meal Prep", de: "Meal Prep", es: "Meal Prep" },
    "tag.style.one-pot": { en: "One Pot", it: "Piatto Unico", fr: "One Pot", de: "Eintopf", es: "Un Solo Plato" },
    "tag.style.budget": { en: "Budget", it: "Economica", fr: "Economique", de: "Guenstig", es: "Economica" },
    "tag.style.gourmet": { en: "Gourmet", it: "Gourmet", fr: "Gourmet", de: "Gourmet", es: "Gourmet" },
